Public Class Form13
    ...
    Private Sub CheckBox4_CheckedChanged(sender As System.Object, e As System.EventArgs)
        If CheckBox5.Checked = True And CheckBox6.Checked = True Then
            MsgBox("wrong answer ")
            Form14.TextBox2.Text = TextBox2.Text
            Form14.Show()
            Me.Hide()
        End If
    End Sub
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs)
        ...
        ElseIf CheckBox5.Checked = True Then
            ...
            Me.Hide()
        End If
        Form14.TextBox2.Text = Form1.TextBox2.Text
        Form14.TextBox2.Text = Form1.TextBox1.Text
        Form14.PictureBox2.Image = Form1.PictureBox1.Image
        Form14.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub CheckBox5_CheckedChanged_1(sender As System.Object, e As System.EventArgs)
        If CheckBox5.Checked = True And CheckBox6.Checked = True Then
            MsgBox("wrong answer ")
            Form14.Show()
            Me.Hide()
    ...
    Private Sub Button2_Click_1(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        ...
        ElseIf CheckBox5.Checked = True Then
            ...
            Me.Hide()
        End If
        Form14.TextBox1.Text = Form1.TextBox2.Text
        Form14.TextBox2.Text = Form1.TextBox1.Text
        Form14.PictureBox2.Image = Form1.PictureBox1.Image
        Form14.Show()
        Me.Hide()
