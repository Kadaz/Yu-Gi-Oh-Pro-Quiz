Public Class Form17
    ...
    Private Sub CheckBox6_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles CheckBox6.CheckedChanged
        If CheckBox4.Checked = True And CheckBox5.Checked = True And CheckBox6.Checked = True Then
            MsgBox("wrong answer ")
            Form18.TextBox2.Text = TextBox2.Text
            Form18.Show()
            Me.Hide()
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        ...
        ElseIf CheckBox5.Checked = True Then
            ...
            Me.Hide()
        End If
        Form18.TextBox1.Text = Form1.TextBox2.Text
        Form18.TextBox2.Text = Form1.TextBox1.Text
        Form18.PictureBox2.Image = Form1.PictureBox1.Image
        Form18.Show()
        Me.Hide()
    End Sub
End Class